...
*a)Getting the coefficient estimates and testing whether beta1 = beta2 *;
proc phreg data = prob4;
model life*status(0) = Z1 Z2/ ties = efron covb;
test Z1 = Z2;
run;

*b) Testing whether radiation (either radiation alone or radiation + BPA, trt = 1) has a different survival
